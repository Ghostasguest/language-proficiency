...
def add_row(is_label_row=False, data=None):
    ...
    if is_label_row:
        ...
        labels = ["Serial Number", "Title", "Category", "Video Upload", "Video Path", "Privacy Status", "Description", "Keywords", "Date", "Time", "Actions"]
        ...
        if data:
            serial_number, title, category, video_path_data, privacy_status_data, description, keywords, date, time = data
            hour, minute, _ = time.split(':')
        else:
            serial_number = str(row_count)
        ...
        # Serial Number
        serial_number_label = tk.Label(frame, text=serial_number, anchor='center')
        serial_number_label.grid(row=row_count, column=0, padx=5, pady=10, sticky="nsew")
        serial_numbers.append(serial_number_label)

        # Title
        title_entry = tk.Entry(frame, justify='center')
        title_entry.insert(0, title)
        title_entry.grid(row=row_count, column=1, padx=5, pady=10, sticky="nsew")
        title_entries.append(title_entry)

        # Category
        category_entry = tk.Entry(frame, justify='center')
        category_entry.insert(0, category)
        category_entry.grid(row=row_count, column=2, padx=5, pady=10, sticky="nsew")
        ...
        video_upload_button.grid(row=row_count, column=3, padx=5, pady=10, sticky="nsew")
        video_upload_buttons.append(video_upload_button)
        video_path_label = tk.Label(frame, textvariable=video_path_var, anchor='center')
        video_path_label.grid(row=row_count, column=4, padx=5, pady=10, sticky="nsew")
        ...
        action_frame.grid(row=row_count, column=10, padx=5, pady=10, sticky="nsew")
